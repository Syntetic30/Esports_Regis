	<?php
		if (ISSET($_POST['submit'])) {
			...
			include 'config.php';
			$result = mysqli_query($connect, "INSERT INTO team VALUES('','$nama','$telp',0)");
					...
					">
						...
						<table width="80%" style="margin-left: 100px;">
							<tr>
								...
								border-radius: 10px;
								"></td>
								<td><a href="loginTeam.php"><input type="" class="btn btn-primary" name="tambah" value="Tambah Anggota" style="
								width: 50%;
								margin-top: 15px;
								border-radius: 10px;
								"></a></td>
